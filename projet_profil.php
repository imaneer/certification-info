...
$query = "SELECT * FROM candidat natural join inscrit where id_candidat = $id"
...
<?php foreach ($cnx->query($query) as $line): ?>
    ...
    <tr>
        <th>Nom</th><td><?= $line['nom'] ?></td>
    </tr>
    <tr>
        <th>Prenom</th><td><?= $line['prenom'] ?></td>
    </tr> 
    <tr>
        <th>Adresse electronique</th><td><?= $line['mail'] ?></td>
    </tr> 
    <tr>
        <th>Identifiant</th><td><?= $line['id_candidat'] ?></td>
    </tr>
    <?php endforeach ?>
</table>
...
<table>
    <tr>
        <th>Session auxquelles je suis inscrit(e)</th>
